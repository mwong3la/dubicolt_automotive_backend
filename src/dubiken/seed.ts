...
export const SEED_USERS: Omit<DubikenUser, 'passwordHash'>[] = [
  {
    id: 'usr_admin',
...
export const DEFAULT_PASSWORD = 'Dubiken123!';
...
export const products: Product[] = [
  {
    ...
    review_count: 12,
    logistics_note:
      'Lead time 14–21 days to Mombasa via sea freight. Customs clearance and last-mile delivery available.',
  },
  {
    id: '2',
...
const refImg1 =
  'https://images.pexels.com/photos/356036/pexels-photo-356036.jpeg?auto=compress&cs=tinysrgb&w=120';

export const adminSourcingRequests: SourcingRequest[] = [
  {
    id: 'sr-1',
...
export const adminSourcingDetails: Record<string, Partial<SourcingRequestDetail>> = {
  'sr-1': {
    quantity: '500 Units',
...
export const adminUserSourcingMap: Record<string, string> = { 'sr-1': 'usr-1' };
...
export const userSourcingDetails: Record<string, UserSourcingDetail> = {
  'usr-1': {
    id: 'usr-1',
...
export const adminCategories: AdminCategory[] = [
  {
    ...
    vendors: 124,
    image_url:
      'https://images.pexels.com/photos/163117/keyboard-full-technology-electronics-163117.jpeg?auto=compress&cs=tinysrgb&w=600',
    status: 'published',
  },
  {
    id: 'ac-2',
...
export const adminInventoryKpis = {
...
export const adminSourcingOrders = [
  {
    id: 'so-1',
...
export const userMarketplaceOrders = [
  {
    id: 'mo-1',
