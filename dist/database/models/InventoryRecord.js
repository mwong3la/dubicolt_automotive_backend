...
let InventoryRecord = class InventoryRecord extends sequelize_typescript_1.Model {
};
...
__decorate([
    ...
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.UUID),
    __metadata("design:type", String)
], InventoryRecord.prototype, "product_id", void 0);
__decorate([
...
], InventoryRecord.prototype, "quantity", void 0);
exports.InventoryRecord = InventoryRecord = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'inventory', timestamps: true, underscored: true })
], InventoryRecord);
